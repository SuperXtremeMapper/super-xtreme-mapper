...
A native macOS TSI editor for Traktor Pro, based in the beloved but long dead Xtreme Mapper. Create, edit, and manage your MIDI controller mappings with a modern, intuitive interface.
