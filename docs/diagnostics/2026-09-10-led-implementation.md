...
## DJM-S7 hardware feedback from tester

The recipient tested the supplied `SXM-LED-Output-Test.tsi` on a DJM-S7 and reported success:

- MIDI value 1 produces blue.
- Deleting the hotcue turns the LED off.
- MIDI value 12 produces cyan / light blue.
